    ...
    <aside className="w-full md:w-[220px] md:flex-shrink-0">
      ...
      <div className="flex flex-wrap gap-2 mb-5">
        <span className="flex items-center gap-1 bg-[#ebebeb] text-[#333] text-xs px-2 py-1 rounded">
          Coupé <button className="ml-1 text-[#999] hover:text-[#333]">✕</button>
        </span>
        {filterUsado && (
          <span className="flex items-center gap-1 bg-[#ebebeb] text-[#333] text-xs px-2 py-1 rounded">
        ...
        {filterDuenioDirecto && (
          <span className="flex items-center gap-1 bg-[#ebebeb] text-[#333] text-xs px-2 py-1 rounded">
            Dueño directo <button className="ml-1 text-[#999] hover:text-[#333]" onClick={() => onFilterDuenioDirecto(false)}>✕</button>
          </span>
        )}
      </div>
      ...
      <div className="space-y-0">
        ...
        {/* Toggle Dueño directo */}
        <div className="flex items-center justify-between py-3 border-b border-[#ddd]">
          <span className="text-sm text-[#333]">Dueño directo</span>
        ...
        {/* Marca */}
        <div className="py-3">
          <p className="text-sm font-semibold text-[#333] mb-2">Marca</p>
        </div>
      </div>
    </aside>
  )
