...
const developers = [
  // feature/dev-portfolio-1 — DEV1: Juan Gallardo
  {
    ...
    description: "Apasionado por crear interfaces modernas y experiencias de usuario excepcionales con tecnologías web actuales.",
    services: ["UI/UX Design", "Web Development", "Responsive Design"],
    technologies: ["React", "TypeScript", "Tailwind CSS", "Next.js"],
    github: "https://github.com/juangallardo19",
    photo: "/images/juan-pablo.jpg",
    portfolio: "/portafolio/juan-gallardo",
  },
  // feature/dev-portfolio-2 — DEV2: Juan Montezuma
  {
    name: "Juan Montezuma",
    role: "Full Stack Developer",
    description: "Especializado en construir aplicaciones robustas y escalables con tecnologías de alto rendimiento.",
    services: ["Backend Development", "API REST", "Database Design"],
    technologies: ["Node.js", "React", "PostgreSQL", "Python"],
    github: "https://github.com/JuanMR2006",
    photo: "/images/juan-jose.jpg",
    portfolio: "/portafolio/juan-montezuma",
  },
  // feature/dev-portfolio-3 — DEV3: Juan Camues
  {
    name: "Juan Camues",
    role: "UI/UX & Frontend Dev",
    description: "Creativo digital con enfoque en animaciones, diseño atractivo y código limpio para la web.",
    services: ["CSS Animations", "Component Design", "JS Interactions"],
    technologies: ["JavaScript", "CSS3", "Figma", "Vue.js"],
    github: "https://github.com/JuanSCC8",
    photo: "/images/sebastian.jpg",
    portfolio: "/portafolio/juan-camues",
  },
]
      ...
      <div className="bg-[#ffe600] py-6">
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="flex flex-col items-center gap-4">
            ...
            >
              {showPortfolios ? "Ocultar portafolios" : "Ver portafolios del equipo"}
              {showPortfolios
